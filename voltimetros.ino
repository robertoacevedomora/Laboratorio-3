...
void loop()
{
  ...
  {
    if (Posi_Nega8 == 0) // Si el voltaje de la fuente es positivo
    ...
    {
      if (Posi_Nega8 == 1) // Si el voltaje de la fuente es negativo
      {                    // Condiciones de alarma de LED
        if (v_in3 * -5 < -24)
        {
          digitalWrite(l_led,HIGH);
  ...
  {
    if (Posi_Nega9 == 0) // Si el voltaje de la fuente es positivo
    {                    // Condiciones de alarma de LED
      if (v_in2 * 5 > 24)
      {
        digitalWrite(l_led, HIGH);
    ...
    {
      if (Posi_Nega9 == 1) // Si el voltaje de la fuente es negativo
      {                    // Condiciones de alarma de LED
        if (v_in2 * -5 < -24)
        {
          digitalWrite(l_led, HIGH);
  ...
  {
    if (Posi_Nega10 == 0) // Si el voltaje de la fuente es positivo
    {                    // Condiciones de alarma de LED
      if (v_in1 * 5 > 24)
      {
        digitalWrite(l_led, HIGH);
    ...
    {
      if (Posi_Nega10 == 1) // Si el voltaje de la fuente es negativo
      {                    // Condiciones de alarma de LED
        if (v_in1 * -5 < -24)
        {
          digitalWrite(l_led, HIGH);
  ...
  {
    if (Posi_Nega11 == 0) // Si el voltaje de la fuente es positivo
    {                    // Condiciones de alarma de LED
      if (v_in0 * 5 > 24)
      {
        digitalWrite(l_led, HIGH);
    ...
    {
      if (Posi_Nega11 == 1) // Si el voltaje de la fuente es negativo
      {                    // Condiciones de alarma de LED
        if (v_in0 * -5 < -24)
        {
          digitalWrite(l_led, HIGH);
